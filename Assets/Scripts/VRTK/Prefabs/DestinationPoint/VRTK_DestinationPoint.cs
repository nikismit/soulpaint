...
namespace VRTK
{
    ...
    public class VRTK_DestinationPoint : VRTK_DestinationMarker
    {
        ...
        protected Collider[] pointColliders;
        ...
        protected virtual void CreateColliderIfRequired()
        {
            ...
            {
                pointColliders = new Collider[1] { gameObject.AddComponent<SphereCollider>() };
        ...
        public virtual void ToggleColliders(bool state)
        {
            ...
            transform.GetChild(0).GetComponent<Renderer>().enabled = state;
        }
