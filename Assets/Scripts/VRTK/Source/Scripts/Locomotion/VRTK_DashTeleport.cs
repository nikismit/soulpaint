...
namespace VRTK
{
    ...
    public class VRTK_DashTeleport : VRTK_HeightAdjustTeleport
    {
        ...
        public event FinishedMoving HasFinishedMoving;
        public static event FinishedMoving StaticHasFinishedMoving;

        public delegate void StartMoving(Vector3 targetPosition);
        public event StartMoving HasStartedMoving;
        ...
        private IEnumerator WaitUntilTeleport()
        {
            Debug.Log("Delay: " + gameObject.name);
            yield return null;
            base.StartTeleport(null, new DestinationMarkerEventArgs());
        }
        ...
        {
            if (HasStartedMoving != null)
                HasStartedMoving.Invoke(targetPosition);
            ...
            if (HasFinishedMoving != null)
                HasFinishedMoving.Invoke();

            if (StaticHasFinishedMoving != null)
                StaticHasFinishedMoving.Invoke();
